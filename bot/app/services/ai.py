...
async def _execute_intent(
    ...
    match intent:
        ...
        case "event_create":
            ...
            return f"🎈 Evento '{insert_data['title']}' adicionado para {insert_data['event_date']}!", None
        ...
        case "task_list":
            ...
            if not r.data:
                return "✨ Nenhuma tarefa pendente!", None
        ...
        case "transaction_create":
            ...
            return f"📄 Entendi que você deseja lançar a despesa:\n\nValor: {amount_fmt} ({tipo})\n\nConfirma?", kb
        ...
        case "transaction_list":
            ...
            if not r.data:
                return "📭 Nenhuma transação registrada.", None
        ...
        case "balance_check":
            ...
            if not r.data:
                return "📊 Sem dados de rateio ainda.", None
        ...
        case "shopping_update":
            ...
            return f"🛒 Item {params['item_name']} atualizado (Nova qtd: {params.get('quantity', '?')})!", None
        ...
        case "shopping_done":
            ...
            if r.data:
                return f"✅ *{r.data[0]['item_name']}* marcado como comprado!", None
            return f"⚠️ Não encontrei '{item_name}' na lista.", None
        ...
        case "weather_check":
            ...
            return await get_weather(city, timeframe), None

        # ── CONVERSA ────────────────────────────────────────────────
        case "chat":
            return None, None  # Só retorna o reply do Gemini
